...
################################################################################
## Form generated from reading UI file 'uifbx.ui'
##
...
"color: rgb(255, 255, 255);")
        ...
        self.horizontalLayoutWidget_2.setGeometry(QRect(10, 280, 321, 31))
        ...
        self.playButtonAction = QPushButton(self.horizontalLayoutWidget_2)
        self.playButtonAction.setObjectName(u"playButtonAction")

        self.horizontalLayout_2.addWidget(self.playButtonAction)

        self.pauseButtonAction = QPushButton(self.horizontalLayoutWidget_2)
        self.pauseButtonAction.setObjectName(u"pauseButtonAction")

        self.horizontalLayout_2.addWidget(self.pauseButtonAction)
    ...
    def retranslateUi(self, Form):
        ...
        self.playButtonAction.setText(QCoreApplication.translate("Form", u"PLAY", None))
        self.pauseButtonAction.setText(QCoreApplication.translate("Form", u"PAUSE", None))
        ...
        self.checkBox_2.setText(QCoreApplication.translate("Form", u"<select>", None))
